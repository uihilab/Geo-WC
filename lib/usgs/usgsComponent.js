...
class usgsComponent extends genericComponent {
    ...
    prepareData(rawData) {
        ...
        // Call datatableComponent to display the table
        dataTableComponent.drawTable(headers, dataArray);
        graphComponent.drawGraph(xData, yData);
    }
};

// Usage: Call usgsComponent to prepare data and display the table
usgsComponent.prepareData();
