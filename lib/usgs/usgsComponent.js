...
class usgsComponent extends genericComponent {
    ...
    async connectedCallback() {
        ...
        // Get the <geoweb-usgs> element by its id
        var geowebUsgsElement = document.getElementById('usgs');

        // Access the 'service' attribute value
        var datatype = geowebUsgsElement.getAttribute('service');
